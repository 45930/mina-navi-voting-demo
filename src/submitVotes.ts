import { Mina, PrivateKey, PublicKey, UInt32, fetchAccount } from 'o1js';
import { TokenElection, PartialBallot, Ballot } from './TokenElection.js';
...
const votes = JSON.parse(await fs.readFile('./src/votes.json', 'utf8'));
console.log(votes)
